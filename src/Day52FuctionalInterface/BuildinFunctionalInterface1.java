...
public class BuildinFunctionalInterface1 {
    ...
    public static void main(String[] args) {
      ...
      /*  for (Integer each : list2) {
        ...
        list2.forEach(p-> {if(p%2!=0) System.out.println(p);});// todo will display every single element


        System.out.println("---------------------------------------------------");

        List<String> employees=new ArrayList<>();
        employees.addAll(Arrays.asList("Anel Alibayeva","Aygun Abbasova","Jilili Jiwuer","Ali Ismayilov"));
        ...
        System.out.println("--------------------------------------------------");
        Function<List<Integer>,int[]> ConvertoArray=(a)->{
        ...
        int[] result2 =ConvertoArray.apply(numbers);
